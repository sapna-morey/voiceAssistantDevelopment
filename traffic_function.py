...
GMAPS_API_KEY = "AIzaSyAkIqW6p2Me3kt3F6PiUj9asDx4CJJXGFY"
...
PEOPLE_AND_PLACES = {
    "Sapna": {
        "work": {
            "address": "Suren Road,Andheri, Mumbai 400093",
            "start": "home"
        },
        "home": {
            "address": "Blue Bell, Central Ave, Hiranandani Gardens, Powai, Mumbai, Maharashtra 400076",
            "start": "work"
        },
        "pune": {
            "address": "Pune,Maharashtra 411011",
            "start": "home"
        }
    },
	"Girish": {
        "work": {
            "address": " Fairmont, Level 2 Hiranandani Business Park,Powai Maharashtra 400076",
            "start": "home"
        },
        "home": {
            "address": "Blue Bell, Central Ave, Hiranandani Gardens, Powai, Mumbai, Maharashtra 400076",
...
def get_welcome_response():
    ...
    speech_output = "Hello, Sapna I can help you lookup the estimated time in " \
...
def get_help_response(intent, session):
    ...
    speech_output = "Sapna, I can help you lookup the estimated time in traffic. " \
